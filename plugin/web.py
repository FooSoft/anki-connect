...
class WebServer:
    ...
    def handlerWrapper(self, req):
        ...
        if allowAllCors:
            ...
            originStr.startswith('chrome-extension://') or originStr.startswith('moz-extension://') or originStr.startsith('safari-web-extension') ) : # allow chrome, firefox and safari extension if localhost allowed
                corsOrigin = originStr
                allowed = True
        else:
            allowed = True
