...
*   **guiAddCards**
    ...
    The `autoAdd` member inside the `options` group can be set to true to add your card without opening any dialogs. This will directly call the `addNote` function, and can be used for easier code legibility.
